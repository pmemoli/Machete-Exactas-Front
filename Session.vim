...
badd +87 src/pages/mate/Mate.jsx
badd +71 src/components/CareerMap/CareerMap.jsx
badd +73 src/pages/compu/Compu.jsx
badd +33 src/components/Materia.jsx
badd +1 src/components/Modal.jsx
badd +20 src/components/GraficoPlan.jsx
...
badd +11 src/assets/styles/graficoplan.scss
argglobal
%argdel
$argadd ./
set stal=2
...
silent! normal! zE
let &fdl = &fdl
let s:l = 87 - ((27 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 87
