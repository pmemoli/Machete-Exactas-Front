...
function Welcome() {
  return (
    <div className='content'>
      <h1>Fisica</h1>
      <p>
      Material para la carrera de Ciencias Fisicas.
      Aca esta la <a href='https://www.df.uba.ar/es/docentes/paginas-de-materias' target='_blank'>pagina de la materia</a> y 
...
export default function Fisica({original, setOriginal}) {
  ...
  const materias = [
    'Fisica 1', 'Matematica 1', 'Laboratorio 1', 'Fisica 2', 'Matematica 3', 'Laboratorio 2', 'Calculo Numerico',
    'Fisica 3', 'Matematica 4', 'Laboratorio 3', 'Fisica 4', 'Mecanica Clasica', 'Fisica Teorica 1', 'Laboratorio 4',
    'Fisica Teorica 2', 'Fisica Teorica 3', 'Laboratorio 5', 'Estructura 1', 'Estructura 2', 'Laboratorio 6', 'Laboratorio 7',
